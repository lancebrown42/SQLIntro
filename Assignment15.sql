...
-- ---------------------------------------------------------------------
-- ---------------------------------------------------------------------
-- Step 1: Customers favorite songs
-- ---------------------------------------------------------------------
SELECT
...
-- ---------------------------------------------------------------------
-- Step 2: Songs recorded after 01/01/2010 ordered by label and artist
-- ---------------------------------------------------------------------
SELECT
	TS.strName as 'Song'
	,TA.strName as 'Artist'
	,TS.strRecordLabel as 'Label'
	,TS.dtmDateRecorded as 'Recording date'

FROM TSongs as TS
	JOIN TArtists as TA
		ON TS.intArtistID = TA.intArtistID
WHERE
	TS.dtmDateRecorded > '01/01/2010'
ORDER BY
	TS.strRecordLabel
	,TA.strName

-- ---------------------------------------------------------------------
-- Step 3: Artists of favorite songs based on gender
-- ---------------------------------------------------------------------
SELECT 
	TA.strName as 'Artist'
...
FROM TCustomers as TC
	...
	JOIN TSongs as TS
		ON TCS.intSongID = TS.intSongID
	JOIN TArtists as TA
		ON TA.intArtistID = TS.intArtistID
ORDER BY
	TG.strGender

-- ---------------------------------------------------------------------
-- Step 4: Artists who have favorite song with females under 21
-- ---------------------------------------------------------------------
SELECT 
	TA.strName as 'Artist'
...
-- ---------------------------------------------------------------------
-- Step 5: List of favorite songs ordered by genre and label
-- ---------------------------------------------------------------------
SELECT
	TS.strName
	,TS.strGenre
